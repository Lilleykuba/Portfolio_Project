<script>
    ...
    let translations = {
        en: {
            ...
            project3Description: "I developed a ToDo web app for myself and my friends to use. It features a simple and clean UI, and is fully responsive. Built with React, TailwindCSS and Firebase.",
